...
<template>
  <teleport to=".entryModalcontainer">
    <div
      class="bg-black bg-opacity-80 h-screen w-full fixed top-0 left-0 flex items-center justify-center px-5 sm:px-12 md:px-0"
    >
      <div class="bg-white p-5 w-4/5 md:w-96 rounded-lg">
        <div>
